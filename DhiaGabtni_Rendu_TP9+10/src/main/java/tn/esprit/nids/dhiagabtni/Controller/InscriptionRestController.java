...
public class InscriptionRestController {
    ...
    @PutMapping("/desaf-insc/{insc-id}")
    public Inscription desafInsc(@PathVariable("insc-id") Long inscID){
        Inscription insc = insciptionService.desaffeecterskieurinscription(inscID);
        return insc;
    }
}
